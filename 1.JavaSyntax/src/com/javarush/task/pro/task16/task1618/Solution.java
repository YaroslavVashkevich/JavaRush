...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ...
        ZonedDateTime timeFromZone = ZonedDateTime.of(fromDateTime, fromZone);
        ZonedDateTime timeToZone = timeFromZone.withZoneSameInstant(toZone);
        LocalDateTime timeToEtc = timeToZone.toLocalDateTime();
        return timeToEtc;
    }
}
